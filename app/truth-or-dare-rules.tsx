// Truth or Dare Rules page - First step in the flow
...
const rules = [
  ...
  'You can skip but must take a penalty'
];

export default function TruthOrDareRulesScreen() {
  ...
  const handleNext = () => {
    router.push('/truth-or-dare-setup' as any);
  };
