// Truth or Drink Rules page - First step in the flow
...
const rules = [
  ...
  'If you refuse to answer, you must take a drink',
  'You have 30 seconds to answer',
  'If time runs out, you must take a drink',
...
export default function TruthOrDrinkRulesScreen() {
  ...
  const handleNext = () => {
    router.push('/truth-or-drink-setup' as any);
  };
    ...
    <View style={styles.container}>
      ...
      >
        <Animated.View style={[styles.header, fadeStyle]}>
          <Text style={styles.title}>Truth or Drink</Text>
