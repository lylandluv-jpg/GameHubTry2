// Fun Trivia Rules page - First step in the flow
...
const rules = [
  ...
  'Each question will appear one by one',
...
export default function FunTriviaRulesScreen() {
