// What if Setup page - Second step in the flow
...
export default function WhatIfSetupScreen() {
  ...
  const handleAddCustomQuestion = () => {
    if (!customQuestion.trim()) {
      Alert.alert('Error', 'Please enter a "What if" question');
      return;
    }
  ...
  const handleNext = () => {
    ...
    // Store selected packs as categories
    setSelectedCategories(selectedPacks);

    // Navigate to game
    router.push('/what-if' as any);
  };
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <Text style={styles.modalLabel}>What if question:</Text>
            <TextInput
            ...
            <Text style={styles.modalLabel}>Subtext (optional):</Text>
            <TextInput
              style={styles.modalInput}
