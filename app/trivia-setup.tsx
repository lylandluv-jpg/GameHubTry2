// Trivia Setup page - Second step in the flow
// Mode selection, player addition (if Challenger), and category selection (single select)
...
const CATEGORIES = [
  { id: 'Geography', name: 'Geography', color: '#1ABC9C' },
  { id: 'History', name: 'History', color: '#3498DB' },
  { id: 'Science', name: 'Science', color: '#9B59B6' },
  { id: 'Sports', name: 'Sports', color: '#E74C3C' },
  { id: 'Entertainment', name: 'Entertainment', color: '#F39C12' },
  { id: 'General', name: 'General Knowledge', color: '#16A085' }
];
...
export default function TriviaSetupScreen() {
  ...
  const handleNext = () => {
    ...
    // Store selected category (as array for compatibility)
