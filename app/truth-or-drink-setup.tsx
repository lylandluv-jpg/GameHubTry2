// Truth or Drink Setup page - Second step in the flow
...
export default function TruthOrDrinkSetupScreen() {
  ...
  useEffect(() => {
    animateFade();
    setSelectedGameId('truth_or_drink');
  }, []);
  ...
  const handleAddCustomQuestion = () => {
    if (!customQuestion.trim()) {
      Alert.alert('Error', 'Please enter a truth question');
      return;
    }
  ...
  const handleNext = () => {
    ...
    // Navigate to game
    router.push('/truth-or-drink' as any);
  };
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <Text style={styles.modalLabel}>Truth question:</Text>
            <TextInput
