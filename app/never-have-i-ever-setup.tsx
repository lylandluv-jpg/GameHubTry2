// Never Have I Ever Setup page - Second step in the flow
...
export default function NeverHaveIEverSetupScreen() {
  ...
  useEffect(() => {
    animateFade();
    setSelectedGameId('never_have_i_ever');
  }, []);
  ...
  const handleNext = () => {
    ...
    // Navigate to game
    router.push('/never-have-i-ever' as any);
  };
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <TextInput
              ...
              placeholder="Enter 'Never have I ever...' statement"
              placeholderTextColor={theme.colors.textMuted}
