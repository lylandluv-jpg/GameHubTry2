// Truth or Dare Setup page - Second step in the flow
...
export default function TruthOrDareSetupScreen() {
  ...
  useEffect(() => {
    animateFade();
    setSelectedGameId('truth_or_dare');
  }, []);
  ...
  const handleNext = () => {
    ...
    // Navigate to game
    router.push('/truth-or-dare-game' as any);
  };
