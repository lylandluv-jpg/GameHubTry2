// Spin the wheel Setup page - Second step in the flow
// Mode selection, player addition (if Challenger)
...
export default function SpinTheWheelSetupScreen() {
  ...
  useEffect(() => {
    animateFade();
    setSelectedGameId('spin_the_wheel');
  }, []);
  ...
  const handleNext = () => {
    ...
    // Navigate to game
    router.push('/spin-the-wheel' as any);
  };
