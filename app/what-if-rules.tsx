// What if Rules page - First step in the flow
...
const rules = [
  'Tap the card to reveal the "What if" question',
  'Read the question out loud to the group',
  'Discuss the scenario with everyone',
  'You have 60 seconds to discuss',
  'When ready, tap "Vote" to start voting phase',
  'During voting, you have 10 seconds to make your choice',
  'Minority group must explain their choice',
  'Tap "Skip" if you want to move to the next question',
  'Game continues until you exit',
  'Have fun and be creative with your answers!'
];

export default function WhatIfRulesScreen() {
  ...
  const handleNext = () => {
    router.push('/what-if-setup' as any);
  };
