// This or That Setup page - Second step in the flow
...
const CATEGORIES = [
  { id: 'spicy', name: '🔥 Spicy / Naughty', description: 'Hot and steamy choices', warning: 'Adults only' },
  { id: 'flirty', name: '😏 Flirty / Seductive', description: 'Playful and seductive choices' },
  { id: 'romantic', name: '💙 Romantic / Emotional', description: 'Sweet and emotional choices' },
  { id: 'life', name: '💰 Life / Deep Choices', description: 'Deep life decisions' },
  { id: 'fun', name: '🎭 Fun & Random', description: 'Fun and random choices' }
];

export default function ThisOrThatSetupScreen() {
  ...
  useEffect(() => {
    animateFade();
    setSelectedGameId('this_or_that');
  }, []);
  ...
  const handleNext = () => {
    ...
    // Navigate to game
    router.push('/this-or-that' as any);
  };
              ...
              >
                <View style={styles.categoryContent}>
                  <View style={styles.categoryHeader}>
                    ...
                    {category.warning && (
                      <Text style={styles.categoryWarning}>⚠️</Text>
                    )}
                  </View>
