    ...
    <GestureHandlerRootView style={{flex: 1}}>
      <SafeAreaProvider>
        <GameSessionProvider>
          ...
          <Stack.Screen name="truth-or-dare-rules" options={{headerShown: false}} />
          <Stack.Screen name="truth-or-dare-setup" options={{headerShown: false}} />
          <Stack.Screen name="truth-or-dare-game" options={{headerShown: false}} />
