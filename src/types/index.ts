...
export type GameId = 'truth_or_dare' | 'never_have_i_ever' | 'would_you_rather' | 'simple_truth_or_dare' | 'simple_would_you_rather' | 'fuck_marry_kill' | 'true_false_trivia' | 'what_if' | 'truth_or_drink' | 'kings_cup' | 'most_likely_to' | 'dice_of_love' | 'this_or_that' | 'trivia' | 'do_or_drink' | 'paranoia' | 'kiss_game' | 'spin_the_wheel' | 'guess_the_emoji' | 'spin_the_bottle' | 'mainstream_or_adult_film' | 'startup_or_scam' | 'florida_man' | 'info_vs_infox' | 'fun_trivia' | 'rapid_fire' | 'sticky_situation' | 'charades' | 'pig' | 'the_password_is' | 'read_my_lips' | 'challenge_champion' | 'through_the_green_glass_door' | 'blabble' | 'thumbs_up_thumbs_down' | 'impostor' | 'word_wizards';
